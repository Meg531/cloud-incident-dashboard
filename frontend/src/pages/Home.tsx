...
? incidents: incidents.filter(i => i.severity.toLowerCase() === filter);
...
<div className="w-full max-w-5xl flex flex-col items-center">
    ...
    <div className="incident-card bg-white p-4 rounded shadow w-full max-w-3xl flex flex-col sm:flex-row gap-4
